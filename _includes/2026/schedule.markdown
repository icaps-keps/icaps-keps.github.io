<section id="schedule" class="pt-24 fade-in opacity-0 translate-y-8 transition-all duration-1000">
...
<div class="max-w-4xl mx-auto px-6 space-y-6 pb-20 text-left">

  <!-- Workshop Introduction -->
  <div class="rounded-xl shadow-sm p-6 text-center" style="background: linear-gradient(135deg, oklch(60.9% 0.126 221.723) 0%, oklch(52% 0.105 223.128) 100%);">
    <div class="flex justify-center mb-2">
      <!-- user-group icon -->
      <svg xmlns="http://www.w3.org/2000/svg" style="width:2.5rem;height:2.5rem;" fill="none" viewBox="0 0 24 24" stroke="white" stroke-width="1.5">
        <path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 016 18.719m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 2.772m0 0a3 3 0 00-4.681 2.72 8.986 8.986 0 003.74.477m.94-3.197a5.971 5.971 0 00-.94 3.197M15 6.75a3 3 0 11-6 0 3 3 0 016 0zm6 3a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-13.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z"/>
      </svg>
    </div>
    <p class="font-bold text-xl" style="color:white;">Workshop Introduction</p>
    <p class="text-sm mt-1" style="color:rgba(255,255,255,0.8);">09:00 – 09:10</p>
  </div>

  <!-- Session 1 -->
  <div class="bg-white/60 backdrop-blur-sm rounded-xl shadow-sm p-6">
    <h2 class="text-xl font-bold text-gray-700">Session 1 · Knowledge Acquisition &amp; Domain Learning</h2>
  ...
  <!-- Coffee Break -->
  <div class="rounded-xl shadow-sm p-5 flex items-center justify-center gap-4" style="background: linear-gradient(135deg, #c8a97e 0%, #a0724a 100%);">
    <!-- coffee cup icon -->
    <!-- <svg xmlns="http://www.w3.org/2000/svg" style="width:2rem;height:2rem;flex-shrink:0;" fill="none" viewBox="0 0 24 24" stroke="white" stroke-width="1.5">
    ...
    <div class="text-center">
      <p class="font-bold text-lg" style="color:white;">Coffee Break</p>
      <p class="text-sm" style="color:rgba(255,255,255,0.8);">10:30 – 10:50</p>
    </div>
  </div>
  ...
  <!-- Lunch Break -->
  <div class="rounded-xl shadow-sm p-6 flex items-center justify-center gap-4" style="background: linear-gradient(135deg, #7dba8b 0%, #3d8b55 100%);">
    <!-- plate with fork and knife icon -->
    <!-- <svg xmlns="http://www.w3.org/2000/svg" style="width:2.25rem;height:2.25rem;flex-shrink:0;" fill="none" viewBox="0 0 24 24" stroke="white" stroke-width="1.5">
      <path stroke-linecap="round" stroke-linejoin="round" d="M12 8.25v-1.5m0 1.5c-1.355 0-2.697.056-4.024.166C6.845 8.51 6 9.473 6 10.608v2.513m6-4.871c1.355 0 2.697.056 4.024.166C17.155 8.51 18 9.473 18 10.608v2.513M15 8.25v-1.5M6 10.608v8.384m0 0a9 9 0 0012 0M6 19.5v-1.5M18 19.5v-1.5M12 10.5a2.25 2.25 0 110 4.5 2.25 2.25 0 010-4.5z"/>
    </svg> -->
    <div class="text-center">
      <p class="font-bold text-xl" style="color:white;">Lunch Break</p>
      <p class="text-sm mt-1" style="color:rgba(255,255,255,0.8);">13:00 – 14:30</p>
    </div>
  </div>

  <!-- Session 3 -->
  <div class="bg-white/60 backdrop-blur-sm rounded-xl shadow-sm p-6">
    <h2 class="text-xl font-bold text-gray-700">Session 3 · Scheduling &amp; Planning Applications</h2>
  ...
  <div class="rounded-xl shadow-sm p-5 flex items-center justify-center gap-4" style="background: linear-gradient(135deg, #c8a97e 0%, #a0724a 100%);">
    ...
    <div class="text-center">
      <p class="font-bold text-lg" style="color:white;">Coffee Break</p>
      <p class="text-sm" style="color:rgba(255,255,255,0.8);">16:00 – 16:20</p>
    </div>
  </div>

  <!-- Session 4 -->
  <div class="bg-white/60 backdrop-blur-sm rounded-xl shadow-sm p-6">
    <h2 class="text-xl font-bold text-gray-700">Session 4 · Robotics &amp; Multi-agent Planning</h2>
  ...
  <!-- Closing -->
  <div class="rounded-xl shadow-sm p-6 text-center" style="background: linear-gradient(135deg, #b06ba8 0%, #7b3fa0 100%);">
    <div class="flex justify-center mb-2">
      <!-- clipboard checklist / questionnaire icon -->
      <svg xmlns="http://www.w3.org/2000/svg" style="width:2.5rem;height:2.5rem;" fill="none" viewBox="0 0 24 24" stroke="white" stroke-width="1.5">
        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25zM6.75 12h.008v.008H6.75V12zm0 3h.008v.008H6.75V15zm0 3h.008v.008H6.75V18z"/>
      </svg>
    </div>
    <p class="font-bold text-xl" style="color:white;">Closing</p>
    <p class="text-sm mt-1" style="color:rgba(255,255,255,0.8);">17:25 – 17:30</p>
  </div>
